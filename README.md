...
| `source.projectDomainID`                 | ID of the project domain for project scoping. Use instead of `projectDomainName` if provided; defaults to `domainID`.    | [**openstack**]            | string   | any                                      | ""         | No       |
